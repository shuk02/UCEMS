...
// Fetch all users with their business info (study level and class section)
$stmt = $con->prepare("SELECT u.username, u.name, u.email, u.phone, u.userimage, bi.study_level, bi.class_section 
                       FROM user u 
                       LEFT JOIN business_info bi ON u.username = bi.username");
$stmt->execute();
...
<html lang="en">
<head>
    <title>Students - Campus Entrepreneurship Manager</title>
