...
$stmt = $con->prepare("SELECT id, email, token_expiry, token_status FROM user WHERE token = ?");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $con->prepare("UPDATE user SET password = ?, token = NULL, token_expiry = NULL, token_status = 1 WHERE token = ?");
