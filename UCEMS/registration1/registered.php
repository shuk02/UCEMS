...
$query="INSERT into lecturers(username,password,name,email,phone,image1,slice1,image2,slice2,image3,slice3,userimage) 
	...
	<div class="container">
		<div class="agile_info">
			...
			<div class="login_info">
                ...
                <p class="account2">Click <a href="../log_in1/login.html">here</a> to login</p>
			</div>
		</div>
	</div>
