		...
		if ($_FILES["file"]["error"] > 0)
			...
			echo "Return Code : " .$_FILES["file"]["error"]. "<br />";
				...
				$photo=$name.".".$extension;
						...
						move_uploaded_file($_FILES["file"]["tmp_name"],"../lecturers/images/lecturers/".$photo); 
						header("Location: update_success.html");
						
						
						include ("db.php");
						$picname="../lecturers/images/lecturers/".$name.".".$extension;
						$query="update lecturers set userimage='$picname' where username='$name'";
